...
public final class InitializationUtils {
    ...
    /**
     * Generates a {@link RuntimeException} if the {@code FAIL_INIT} environment variable is {@code true}. Otherwise does nothing.
     */
    public void fail() {
        Optional.ofNullable(this.environment.get("FAIL_INIT"))
